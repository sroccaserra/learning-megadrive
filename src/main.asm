...
USERINIT:	MOVE.W	#0,PLAY1X		;SET START PLAYFIELD 1 X POSITION TO ZERO
		...
		DMADUMP MAPGFX,4*32,$20		;DUMP 4 CHARACTERS (SIZE 32 BYTES EACH) TO
		DMADUMP SPRITEGFX,8*32,$1000	;DUMP 8 CHARACTERS (SIZE 32 BYTES EACH) TO
...
;	MAIN GAME LOOP
;------------------------------
MAIN:		WAITVBI					;WAITS FOR THE START OF THE NEXT F
		ADD.W	#1,PLAY1X			;SCROLL PLAYFIELD 1 RIGHT BY ONE P
		ADD.W	#1,PLAY1Y			;SCROLL PLAYFIELD 1 UP BY ONE PIXE
;ADD SPRITES
		LEA.L	SPRITETEMP,A1			;POINT TO TEMPORARY MEMORY TO BUIL

		MOVE.W	SONICY,(A1)+			;Y POSITION ($80 IS TOP OF SCREEN)
		MOVE.W	#S_2X4+1,(A1)+			;SIZE 2X4 CHARACTERS, NEXT SPRITE
		MOVE.W	#S_PAL2+$1000/32,D0		;PALETTE NUMBER+GRAPHIC VRAM LOCAT
		ADD.W	SONICD,D0
...
;		MAP GRAPHICS
;----------------------------------------------------------
MAPGFX:		DC.B    $66,$66,$66,$66         ;01     FULL CHARACTER USING COLOU
		DC.B	$66,$66,$66,$66
		DC.B	$66,$66,$66,$66
		DC.B	$66,$66,$66,$66
		DC.B	$66,$66,$66,$66
