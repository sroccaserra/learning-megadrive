...
CHARGFX:        incbin "bin/char.dat"
;               MAP GRAPHICS
MAPGFX:         incbin "bin/background_tiles.gfx"
;               SPRITE GRAPHICS
SPRITEGFX:      incbin "bin/sprite.gfx"
;               USER PALETTES
PALETTE1:       incbin "bin/background_tiles.pal"
PALETTE2:       incbin "bin/sprite.pal"
